...
object EurosOOP extends Euros:
  case class Euro private(private val cents: Int):
    override def toString(): String = s"E${cents / 100}.${cents % 100}"

  object Euro:
    def apply(euros: Int, cents: Int): Euro =
      require(euros >= 0 && (cents >= 0 && cents < 100))
      new Euro(euros * 100 + cents)

  extension (e: Euro)
    def +(other: Euro): Euro = Euro(e.cents + other.cents)
    def show: String = e @@.toString ()

end EurosOOP

object EurosFP extends Euros:
