error id: 063D3995F674817DC33918A5357C9AD7
...
object EurosOOP:
  ...
  object Euro:
    private case class EuroImpl(cents: Int) extends Euro {
      override def +(other: Euro): Euro = other m @@
...
java.base/jdk.internal.util.Preconditions$1.apply(Preconditions.java:55)
	...
	dotty.tools.dotc.interactive.Completion$Completer.extensionCompletions(Completion.scala:638)
	dotty.tools.dotc.interactive.Completion$Completer.selectionCompletions(Completion.scala:495)
